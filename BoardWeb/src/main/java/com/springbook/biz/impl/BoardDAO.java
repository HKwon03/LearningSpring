...
public class BoardDAO {
	...
	public void insertBoard(BoardVO vo) {
		System.out.println("==> JDBC로 insertBoard() 기능처리 됨");
	...
	public void updateBoard(BoardVO vo) {
		System.out.println("==> JDBC로 updateBoard() 기능처리 됨");
		try {
	...
	public void deleteBoard(BoardVO vo) {
		System.out.println("==> JDBC로 deleteBoard() 기능처리 됨");
		try {
			conn = JDBCUtil.getConnection();
	...
	public BoardVO getBoard(BoardVO vo) {
		System.out.println("==> JDBC로 getBoard() 기능처리 됨");
		BoardVO board = null;
		...
		try {
			...
			if(rs.next()) {		//select 한 결과값이 존재한다면 rs의 값을 board에 setter 주입
				board = new BoardVO();
				board.setSeq(rs.getInt("SEQ"));
				board.setTilte(rs.getString("TITLE"));
	...
	public List<BoardVO> getBoardList(BoardVO vo) {
		...
		System.out.println("==> JDBC로 getBoardList() 기능처리 됨");
		...
		try {
			...
			while(rs.next()) {	//DB에서 select한 결과 값을 vo에 저장해서 
				...
				boardList.add(board);	//board를 ArrayList에 저장함.
			}
